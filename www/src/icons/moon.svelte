  ...
  >
    <path d="M13 4h1.5M13 4h-1.5M13 4v1.5M13 4v-1.5">
      ...
      <set
        fill="freeze"
        attributeName="d"
        begin="lineMdMoonTwotoneAltLoop0.begin+1.8s"
        to="M12 5h1.5M12 5h-1.5M12 5v1.5M12 5v-1.5"
      />
      <set
        fill="freeze"
        attributeName="d"
        begin="lineMdMoonTwotoneAltLoop0.begin+3.8s"
        to="M12 4h1.5M12 4h-1.5M12 4v1.5M12 4v-1.5"
      />
      <set
        fill="freeze"
        attributeName="d"
        begin="lineMdMoonTwotoneAltLoop0.begin+5.8s"
    ...
    <path d="M19 11h1.5M19 11h-1.5M19 11v1.5M19 11v-1.5">
      ...
      <set
        fill="freeze"
        attributeName="d"
        begin="lineMdMoonTwotoneAltLoop1.begin+1.8s"
        to="M17 11h1.5M17 11h-1.5M17 11v1.5M17 11v-1.5"
      />
      <set
        fill="freeze"
        attributeName="d"
        begin="lineMdMoonTwotoneAltLoop1.begin+3.8s"
        to="M18 12h1.5M18 12h-1.5M18 12v1.5M18 12v-1.5"
      />
      <set
        fill="freeze"
        attributeName="d"
        begin="lineMdMoonTwotoneAltLoop1.begin+5.8s"
    ...
    <path d="M19 4h1.5M19 4h-1.5M19 4v1.5M19 4v-1.5">
      <animate
        ...
        fill="freeze"
        attributeName="stroke-dashoffset"
        begin="2s;lineMdMoonTwotoneAltLoop2.begin+6s"
        dur="0.4s"
        values="4;0"
      />
      <animate
      ...
      <set
        fill="freeze"
        attributeName="d"
        begin="lineMdMoonTwotoneAltLoop2.begin+1.8s"
        to="M20 5h1.5M20 5h-1.5M20 5v1.5M20 5v-1.5"
      />
      <set
        fill="freeze"
        attributeName="d"
        begin="lineMdMoonTwotoneAltLoop2.begin+5.8s"
